<div>
    ...
    <h1 class="text-center mb-3 mt-2 font-bold text-xl mb-4">   گەڕانەوەی کاڵا فرۆشراوەکان بە قەرز </h1>
                ...
                <div class="w-full lg:w-5/6 ">
                    ...
                    <div class=" shadow-md rounded my-6">
                        ...
                        <span class="flex items-center col-span-3">
                            بینینی بەشەکان {{ $FroshtnBaQarz->currentPage() }}-{{ $FroshtnBaQarz->lastItem() }} لە {{ $FroshtnBaQarz->currentPage() }}
                        </span>
