    ...
    <div class="flex justify-evenly">
        ...
        <div  class="xl:w-1/3 sm:w-3/4 md:w-2/5   relative   xl:max-w-sm lg:w-2/5">
            <button  type="button" data-modal-toggle="large-modal"   class="bg-green-300 cursor-pointer hover:bg-green-600 rounded-lg px-4 py-4 ">
                <p class="text-sm font-medium leading-none truncate">زیادکردن تێبینی</p>
            </button>
        </div>
                ...
                <table class="min-w-max w-full table-auto">
                    <thead>
                        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            <th class="py-3 px-6 text-left">ناو</th>
                            <th class="py-3 px-6 text-left">ژمارە تەلەفون</th>
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                            ...
                            <div class="relative p-4 w-full max-w-4xl h-full md:h-auto">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="px-6 py-6 lg:px-8 text-center items-center">
                                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white mb-3 mt-1">زیادکردنی تێبینی</h3>
                                        <form wire:submit.prevent="EditDaily" class="space-y-6" action="#">
                                            <div>
                                                <label 
                        ...
                        focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                            ...
                                            <div>
                                                ...
                                                <input type="text"   wire:model.defer="update_phone"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900   @error('update_phone') border border-red-500  @enderror
...
<div wire:ignore.self id="large-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-4xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8 text-center items-center">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white mb-3 mt-1">زیادکردنی تێبینی</h3>
                <form wire:click.prevent="SaveDaily" class="space-y-6" action="#">
                    <div>
                        <label for="email" 
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">ناوی
                            بەکارهێنەر</label>
...
text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                    ...
                    <div>
                        ...
                        class="bg-gray-50 border border-gray-300 text-gray-900   @error('notes') border border-red-500  @enderror
                        text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        name="" id="" cols="30" rows="10"></textarea>
