...
<h1 class="text-center mb-3 mt-2 font-bold text-xl mb-4">بەشی شوڤێر</h1>
                    ...
                    <div class="xl:w-1/3 sm:w-3/4 md:w-2/5  relative   xl:max-w-sm lg:w-2/5">
                        <div class="relative w-full mr-6 focus-within:text-purple-500">
                            ...
                            <input wire:model="search"
                                ...
                                type="text" placeholder="ناوی شوفێر" aria-label="Search" />
                        </div>
                    </div>
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-right">
                                    <div class="flex item-center justify-end">
                                        ...
                                        <div data-modal-toggle="authentication-modal3" wire:click.prevent="edit('{{ $driver->id }}')" class="w-4 mr-2 transform text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                            </svg>
                                        </div>
                                        <div wire:click.prevent="delete('{{ $driver->id }}')" class="w-4 mr-2  transform text-red-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="relative w-full h-full max-w-md p-4 md:h-auto">
    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="px-6 py-6 lg:px-8">
            <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">زیادکردنی شوڤێر</h3>
            <form wire:submit.prevent="EditDriver" class="space-y-6" action="#">
                <div  class="mt-4 mb-3">
                    <label for="email" 
...
<div class="relative w-full h-full max-w-md p-4 md:h-auto">
    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="px-6 py-6 lg:px-8">
            <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">زیادکردنی شوڤێر</h3>
            <form wire:submit.prevent="SaveDriver" class="space-y-6" action="#">
                <div>
                    <label for="email" 
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">ناوی
                        شوڤێر</label>
