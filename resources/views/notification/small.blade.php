<div class="mt-5 p-8">
    ...
    @section('title','Notification')
        ...
        <h1 class="text-center text-xl">ئەو کاڵایانی بەسەرچوون</h1>

      
    
     <div class="mx-auto w-70 my-4 p-3 ">
            <div class="truncate flex flex-col space-y-4 bg-white border-b border-gray-200">
                     ئە و کاڵایانەی کە  ماوە بۆ بەسەرچوون
            ...
            <!-- card footer -->
            <div class="p-6 flex justify-end bg-white border-gray-200 ">
                ...
                <!-- button link -->
                    ...
                    <div class=" mt-3 m-2">
                        ...
                        <!-- button link -->
                        <a  class="" 
                            href="#">  <span class="font-bold text-red-500">{{ $sum_expired }}</span> : دانە </a>
                    </div>
                    
                <a wire:click.prevent="getDateRange" class="bg-yellow-500 flex  shadow-md text-sm text-white font-bold py-3 px-4 hover:bg-yellow-600 rounded uppercase" 
                href="#">
